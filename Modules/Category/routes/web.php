...
Route::group(['prefix' => 'app', 'as' => 'backend.', 'middleware' => ['auth']], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'categories', 'as' => 'categories.'], function () {
        ...
        Route::post('update-gift-card-status/{id}', [CategoriesController::class, 'update_gift_card_status'])->name('update_gift_card_status');
        Route::post('update-online-status/{id}', [CategoriesController::class, 'update_online_status'])->name('update_online_status');
