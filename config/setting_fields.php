    ...
    'integration' => [
        ...
        'elements' => [
            ...
            [
                ...
                'data'  => 'taqnyat_sms', // data type, string, int, boolean
                'name'  => 'taqnyat_gift_recipient_message', // unique name for field
    ...
    'payment' => [
        ...
        'elements' => [
            ...
            [
                'type' => 'select',
                'data' => 'string',
                'name' => 'tap_payment_discount_type',
                'label' => 'Hyperpay Discount Type',
                'rules' => 'nullable|in:fixed,percent',
                'class' => '',
                'value' => 'fixed',
                'options' => [
                    'fixed' => 'Fixed Amount',
            ...
            [
                'type' => 'text',
                'data' => 'string',
                'name' => 'tap_payment_discount_amount',
                'label' => 'Hyperpay Discount Value',
            ...
            [
                'type' => 'checkbox',
                'data' => 'boolean',
                'name' => 'tap_card_payment_method',
                'label' => 'Tap Visa / MasterCard',
                'rules' => '',
                'class' => '',
                'value' => '1',
            ],
            [
                'type' => 'checkbox',
                'data' => 'boolean',
                'name' => 'tap_apple_pay_payment_method',
                'label' => 'Tap Apple Pay',
                'rules' => '',
                'class' => '',
                'value' => '1',
            ...
            [
                'type' => 'select',
                'data' => 'string',
                'name' => 'urpay_payment_discount_type',
                'label' => 'UrPay Discount Type',
                'rules' => 'nullable|in:fixed,percent',
                'class' => '',
                'value' => 'fixed',
                'options' => [
            ...
            [
                'type' => 'text',
                'data' => 'string',
                'name' => 'urpay_payment_discount_amount',
                'label' => 'UrPay Discount Value',
                'rules' => 'nullable|numeric|min:0',
                'class' => '',
                'value' => '0',
            ],
            ...
            [
                'type' => 'select',
                'data' => 'string',
                'name' => 'tabby_payment_discount_type',
                'label' => 'Tabby Discount Type',
                'rules' => 'nullable|in:fixed,percent',
                'class' => '',
                'value' => 'fixed',
                'options' => [
            ...
            [
                'type' => 'text',
                'data' => 'string',
                'name' => 'tabby_payment_discount_amount',
                'label' => 'Tabby Discount Value',
                'rules' => 'nullable|numeric|min:0',
                'class' => '',
                'value' => '0',
            ],
            ...
            [
                'type' => 'select',
                'data' => 'string',
                'name' => 'tamara_payment_discount_type',
                'label' => 'Tamara Discount Type',
                'rules' => 'nullable|in:fixed,percent',
                'class' => '',
                'value' => 'fixed',
                'options' => [
            ...
            [
                'type' => 'text',
                'data' => 'string',
                'name' => 'tamara_payment_discount_amount',
                'label' => 'Tamara Discount Value',
                'rules' => 'nullable|numeric|min:0',
                'class' => '',
                'value' => '0',
            ],
