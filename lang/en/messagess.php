...
return [
    ...
    'otp_code_expired' => 'Verification code expired, please resend the code.',
    'invalid_otp' => 'The OTP is incorrect.',
    'mobile_verified_success' => 'Mobile verified successfully!',
    ...
    'optional_msg' => 'The phrases to be written (do not exceed 100 characters)',
  ...
  'soft_notes' => 'Important note:',
  'note_1' => '- Gift box for gifts valued at 400 riyals or more per service; lesser gifts incur an additional charge of 35 riyals.',
  'note_2' => '- The electronic card will be sent within 24 hours of completing the request during working hours from 11:00 AM to 10:00 PM',
  'note_3' => '- If you require pickup from the center, please contact us to confirm its availability. Pick-up hours are between 2:00 PM and 8:00 PM.',
  'note_4' => '- To use the gift card, it must be shown to the booking agent; if it is lost, the service cannot be used.',
  'total_amount' => 'Total Amount:',
  'proceed_to_payment' => 'Proceed to Payment',
...
'minutes' => 'minutes',
  ...
  'no_branches_available' => 'There are currently no branches offering this service.',
  'error_loading_branches' => 'An error occurred while loading the available branches. Please try again.',
  'book_now' => 'Book Now',
  'SAR' => 'SAR',
  'navItems' => 'Navigation Items',
    ...
    'occasions_management' => 'Occasions & Targeted SMS',
    'occasions' => 'Occasions',
