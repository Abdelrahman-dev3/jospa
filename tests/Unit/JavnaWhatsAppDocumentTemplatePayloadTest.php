...
{
    public function test_invoice_document_template_payload_includes_six_localizable_body_params(): void
    {
    ...
    public function test_gift_card_document_template_payload_includes_four_localizable_body_params(): void
    {
